...
function ResultReciept({ navigation }) {
  return (
          ...
          >
            ...
            <View style={styles.middleContents}>
              <View style={styles.numtext}>
                ...
                <Text style={styles.num}>Successful</Text>
              </View>

              <View style={styles.numtext}>
                <Text style={styles.num}>Receipt ID:</Text>
                <Text style={styles.num}>000345378766</Text>
              </View>

              <View style={styles.numtext}>
                <Text style={styles.num}>Exchange Ref:</Text>
                <Text style={styles.num}>0000875634389673536333</Text>
              </View>

              <View style={styles.numtext}>
                <Text style={styles.num}>Date:</Text>
                <Text style={styles.num}>5th Jul 2022 12:37PM</Text>
              </View>

              <View style={styles.numtext}>
                <Text style={styles.num}>Mobile Number:</Text>
                <Text style={styles.num}>08145991555</Text>
              </View>

              <View style={styles.numtext}>
                <Text style={styles.num}>Mobile Network:</Text>
                <Text style={styles.num}>MTN</Text>
              </View>

              <View style={styles.numtext}>
                <Text style={styles.num}>Charges:</Text>
                <Text style={styles.num}>N0.00</Text>
              </View>
            </View>
            <View style={styles.nearbuttom}>
              ...
              <View style={styles.numtext}>
                ...
                <Text style={styles.num}>#1,000</Text>
              </View>
            </View>
            {/* buttom content */}
