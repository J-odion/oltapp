...
function RechargeSummary({ navigation }) {
  return (
        ...
        >
          <View style={styles.funding}>
            <View style={styles.topPage}>
              <Text style={styles.fund}>Recharge Summary</Text>
              {/* form group */}
              <View style={styles.Secfund}>
                <View style={styles.groupes}>
                  <View style={styles.price}>
                    <Text style={styles.label}>John Smith</Text>
                    <Text style={styles.label}>#500</Text>
                  </View>
                  <View>
                    <Text style={styles.label}>Funding For</Text>
                  </View>
